...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_121524) do
  ...
  create_table "medicines", force: :cascade do |t|
    ...
    t.index ["specialty_id"], name: "index_medicines_on_specialty_id"
  end
  ...
  add_foreign_key "medicines", "specialties"
end
